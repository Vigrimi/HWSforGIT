...
public class WritoToFile
{
    protected File file;
    public WritoToFile(File file)
    {
        setFile(file);
    }
    ...
    public boolean writeToFile(byte[] data) // тру если запись в файл удалась
    {
        boolean result = false;
        // try with resources - так называется когда круглые скобки после трай
        ...
        {
            outputStream.write(data); // массив в файл
            result = true;
